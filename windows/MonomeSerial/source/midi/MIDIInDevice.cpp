...
{
#ifdef DEBUG_PRINT
	cout << "attempting to close CMIDIInDevice..." << endl;
#endif
...
#ifdef DEBUG_PRINT
	cout << "CMIDIInDevice event: " << m_Event << endl;
#endif

    // Close handle to signalling event
    ::CloseHandle(m_Event);
#ifdef DEBUG_PRINT
	cout << "deleted CMIDIInDevice" << endl;
#endif
}
...
void CMIDIInDevice::Open(UINT DeviceId)
{
    ...
    MMRESULT Result = ::midiInOpen(&m_DevHandle, DeviceId, 
                                  ...
                                  CALLBACK_FUNCTION);
	// changed DWORD to DWORD_PTR - daniel b
    ...
    {
#ifdef DEBUG_PRINT
		cout << "CMIDIInDevice::Open() failed: " << Result << endl;
#endif
        throw CMIDIInException(Result);
    }
}
...
void CMIDIInDevice::Close()
{
    ...
    if(m_State == OPENED)
    {
        ...
        {
#ifdef DEBUG_PRINT
			cout << "Midi In Device close result: " << Result << endl;
#endif
            throw CMIDIInException(Result);
        }
